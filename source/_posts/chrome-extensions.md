...
https://chrome.google.com/webstore/detail/markdown-cheatsheet/hoglmefbfenoehjeblinfijldanifljm
...
一个**简单**的笔记工具，浏览网页时可以作为便签、备忘录，尤其适用于临时记录。记录的内容不与网页关联。多页签，可以一键插入时间、当前url，无需登录，自动保存，自动同步记录到Chrome（浏览器需要登录谷歌账户）。 
